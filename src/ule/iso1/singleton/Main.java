...
public class Main {
	...
	//Mario Celada Matías 71814922K

	//Iván Sánchez Revuelta 71969576T

	//Elisa García Rodríguez  71476836N

	//Santiago Calvo de la Fuente 71477328K

	public static void main(String[] args) {
		   // Instancia la variable singleton
	       VATtoApply va1 = VATtoApply.getInstance(0.16);
	       //VATtoApply va1 = new VATtoApply(0.16);    // cambiar por la linea anterior para utilizar el patrÃ³n Singleton
	 
	      // Intenta instanciar un segundo singleton: debe devolver la misma instancia
	       VATtoApply va2 = VATtoApply.getInstance(0.20);
	       //VATtoApply va2 = new VATtoApply(0.20);    // cambiar por la linea anterior para utilizar el patrÃ³n Singleton
	     ...
	     //VATtoApply va3 = new VATtoApply(0.30);  // cambiar por la linea anterior para utilizar el patrÃ³n Singleton
